...
const container = document.getElementById('scene-15');
...
loader.load('model/cluster15.gltf', (gltf) => {
  ...
  model.scale.set(0.08, 0.08, 0.08); // Adjust the scale as needed
  scene.add(model);

  // Set up rotation animation
  const animateModel = () => {
    model.rotation.y += 0.007; // Adjust the rotation speed as needed
    model.rotation.x += 0.007; // Adjust the rotation speed as needed
  };
