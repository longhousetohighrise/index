...
const container = document.getElementById('scene-14');
...
loader.load('model/cluster14.gltf', (gltf) => {
  ...
  model.scale.set(0.4, 0.4, 0.4); // Adjust the scale as needed
  scene.add(model);

  // Set up rotation animation
  const animateModel = () => {
    model.rotation.y += 0.006; // Adjust the rotation speed as needed
    model.rotation.x += 0.006; // Adjust the rotation speed as needed
  };
