...
const container = document.getElementById('scene-16');
...
loader.load('model/cluster16.gltf', (gltf) => {
  ...
  model.scale.set(0.6, 0.6, 0.6); // Adjust the scale as needed
  scene.add(model);

  // Set up rotation animation
  const animateModel = () => {
    model.rotation.y += 0.008; // Adjust the rotation speed as needed
    model.rotation.x += 0.008; // Adjust the rotation speed as needed
  };
